    ...
    private class SubList extends AbstractList<E> implements RandomAccess {
        ...
        public E set(int index, E e) {
            ...
            if (java.util.ArrayList.this.modCount != this.modCount)
                throw new ConcurrentModificationException();
            E oldValue = (E) java.util.ArrayList.this.elementData[offset + index];
        ...
        public E get(int index) {
            ...
            if (java.util.ArrayList.this.modCount != this.modCount)
                throw new ConcurrentModificationException();
            return (E) java.util.ArrayList.this.elementData[offset + index];
        }
        ...
        public Spliterator<E> spliterator() {
            if (modCount != java.util.ArrayList.this.modCount)
                throw new ConcurrentModificationException();
